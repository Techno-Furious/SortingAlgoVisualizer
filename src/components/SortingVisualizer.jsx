        ...
        switch (animation.type) {
          case ANIMATION_TYPES.COMPARE:
            ...
            if (arrayBars[animation.indices[0]] && arrayBars[animation.indices[1]]) {
              arrayBars[animation.indices[0]].style.backgroundColor = COMPARE_COLOR;
              arrayBars[animation.indices[1]].style.backgroundColor = COMPARE_COLOR;
              ...
              lastColorResetTimeoutRef.current = resetTimeoutId;
              animationTimeoutsRef.current.push(resetTimeoutId);
            }
            break;
      ...
      <div className="array-container">
        {array.map((value, idx) => (
          <div 
            ...
            style={{
              height: `${value * 3}px`,
              width: `${Math.max(25, Math.min(50, 800 / arraySize))}px`,
